...
public class BatchConfig {
    //como primer paso leemos el csv -> calculamos el promedio -> escribimos en Mysql
    ...
    //paso 2:leemos MySql -> determinamos el estado -> escribimos en MondoDB
    ...
    //Job: ejecutamos el paso 1 y luego el paso 2
    @Bean
